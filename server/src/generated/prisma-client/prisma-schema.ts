...
type Menu {
  ...
  menu: Menu
  name: String!
  items(where: MenuWhereInput, orderBy: MenuOrderByInput, skip: Int, after: String, before: String, first: Int, last: Int): [Menu!]
}
...
type Mutation {
  ...
  updateStepResult(data: StepResultUpdateInput!, where: StepResultWhereUniqueInput!): StepResult
  updateManyStepResults(data: StepResultUpdateManyMutationInput!, where: StepResultWhereInput): BatchPayload!
  upsertStepResult(where: StepResultWhereUniqueInput!, create: StepResultCreateInput!, update: StepResultUpdateInput!): StepResult!
  ...
  updateTimeResult(data: TimeResultUpdateInput!, where: TimeResultWhereUniqueInput!): TimeResult
  updateManyTimeResults(data: TimeResultUpdateManyMutationInput!, where: TimeResultWhereInput): BatchPayload!
  upsertTimeResult(where: TimeResultWhereUniqueInput!, create: TimeResultCreateInput!, update: TimeResultUpdateInput!): TimeResult!
  ...
  updateWelcome(data: WelcomeUpdateInput!, where: WelcomeWhereUniqueInput!): Welcome
  updateManyWelcomes(data: WelcomeUpdateManyMutationInput!, where: WelcomeWhereInput): BatchPayload!
  upsertWelcome(where: WelcomeWhereUniqueInput!, create: WelcomeCreateInput!, update: WelcomeUpdateInput!): Welcome!
...
type Query {
  ...
  stepResults(where: StepResultWhereInput, orderBy: StepResultOrderByInput, skip: Int, after: String, before: String, first: Int, last: Int): [StepResult]!
  stepResultsConnection(where: StepResultWhereInput, orderBy: StepResultOrderByInput, skip: Int, after: String, before: String, first: Int, last: Int): StepResultConnection!
  ...
  timeResults(where: TimeResultWhereInput, orderBy: TimeResultOrderByInput, skip: Int, after: String, before: String, first: Int, last: Int): [TimeResult]!
  timeResultsConnection(where: TimeResultWhereInput, orderBy: TimeResultOrderByInput, skip: Int, after: String, before: String, first: Int, last: Int): TimeResultConnection!
  ...
  welcomes(where: WelcomeWhereInput, orderBy: WelcomeOrderByInput, skip: Int, after: String, before: String, first: Int, last: Int): [Welcome]!
  welcomesConnection(where: WelcomeWhereInput, orderBy: WelcomeOrderByInput, skip: Int, after: String, before: String, first: Int, last: Int): WelcomeConnection!
  node(id: ID!): Node
}
...
type Step {
  ...
  question: String!
  target: Menu!
  path(where: MenuWhereInput, orderBy: MenuOrderByInput, skip: Int, after: String, before: String, first: Int, last: Int): [Menu!]
  results(where: StepResultWhereInput, orderBy: StepResultOrderByInput, skip: Int, after: String, before: String, first: Int, last: Int): [StepResult!]
}
...
type Subscription {
  ...
  stepResult(where: StepResultSubscriptionWhereInput): StepResultSubscriptionPayload
  test(where: TestSubscriptionWhereInput): TestSubscriptionPayload
  testResult(where: TestResultSubscriptionWhereInput): TestResultSubscriptionPayload
  timeResult(where: TimeResultSubscriptionWhereInput): TimeResultSubscriptionPayload
...
type Test {
  ...
  steps(where: StepWhereInput, orderBy: StepOrderByInput, skip: Int, after: String, before: String, first: Int, last: Int): [Step!]
  menus(where: MenuWhereInput, orderBy: MenuOrderByInput, skip: Int, after: String, before: String, first: Int, last: Int): [Menu!]
  results(where: TestResultWhereInput, orderBy: TestResultOrderByInput, skip: Int, after: String, before: String, first: Int, last: Int): [TestResult!]
}
...
type TestResult {
  ...
  time: TimeResult
  steps(where: StepResultWhereInput, orderBy: StepResultOrderByInput, skip: Int, after: String, before: String, first: Int, last: Int): [StepResult!]
  status: ResultStatus!
}
