...
export async function seedingDataBase() {
  ...
  const steps = [
    ...
    },
    {
      ...
      question: 'Encontre a ferramenta utilizada para lançar notas de alunos.',
      userType: [userProfessor],
    },
    {
    ...
    {
      paths: [[Ensino, EducacaoBasica], [Sociedade, Servicos, EducacaoBasica]],
      question:
    ...
    {
      paths: [[Ensino, FormacaoDocente], [Alunos, Formacao, FormacaoDocente]],
      question:
  ...
  return {
    ...
    targets: setConnectMany(
      paths
        ...
        .filter(
          (item: any, pos: number, arr: any[]) => arr.indexOf(item) === pos,
        ),
    ),
