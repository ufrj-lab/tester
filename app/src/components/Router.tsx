...
import { IComponentQuery } from '../interfaces';

export default ({ first = 1 }: IComponentQuery) => 
                ...
                ({ loading, error, data }: any) => {
                    ...
                    return (
                        <Switch>
                            ...
                            <Route exact path="/teste" render={
                                props => <Test {...props} prefixTitle={prefixTitle}/>
                            }/>                                
                            <Route exact path="/obrigado">
                                <Home prefixTitle={prefixTitle} />
                            </Route>
                            <Route path="/:path" render={
                                props => <NotFound {...props} prefixTitle={prefixTitle} />
                            }/>
                        </Switch>
                    )
                }
